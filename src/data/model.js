...
export const featured = [
  {
    ...
    color: '#3dff6e',
    live: true,
    url: 'https://ianrio.github.io/ian-portfolio-main/',
    cta: 'Ver web →',
    img: '/assets/projects/placeholder1.png',
    desc: 'Proyecto en React para hacer un portfolio estilizado a lo Persona 5',
  },
  {
    title: 'Website Wordpress <Entusfogones>',
    tag: 'Live Web',
    color: '#00e6c4',
    live: true,
    url: 'https://entusfogones.es/',
    cta: 'Ver web →',
    img: '/assets/projects/placeholder2.png',
    desc: 'Desarrollo web a medida en Wordpress',
  },
  {
    title: 'Website Wordpress <MPPapeleria>',
    tag: 'Live Web',
    color: '#f1e05a',
    live: true,
    url: 'https://mp-papeleria.es/',
    cta: 'Ver en GitHub →',
    img: '/assets/projects/placeholder3.png',
    desc: 'Desarrollo web a medida en Wordpress',
  },
  {
    title: 'Website Elementor <CaMudanzas>',
    tag: 'Live Web',
    color: '#3178c6',
    live: true,
    url: 'https://camudanzas.es/',
    cta: 'Ver en GitHub →',
    img: '/assets/projects/placeholder4.png',
    desc: 'Desarrollo web a medida en Elementor',
  },
]
